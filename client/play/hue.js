...
.run(function($rootScope, bopitSock, bopitAudio) {
    ...
    //CHANGE LIGHT COLOR
        ...
        //Group
        var commandurlLight = 'http://192.168.1.115/api/newdeveloper/groups/0/action'; 
    ...
    //FAIL LIGHTS
        var commandurlLightFail11 = 'http://192.168.1.115/api/newdeveloper/lights/1/pointsymbol';
        var commandurlLightFail12 = 'http://192.168.1.115/api/newdeveloper/lights/2/pointsymbol';
        var commandurlLightFail13 = 'http://192.168.1.115/api/newdeveloper/lights/3/pointsymbol';
        var messagebodyFail1 = '{"1":"0A00F1F01F1F1001F1FF100000000001F2F"}';

        var commandurlLightFail21 = 'http://192.168.1.115/api/newdeveloper/groups/0/transmitsymbol';
